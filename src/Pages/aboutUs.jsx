        ...
        <div className="min-h-[100vh] w-full">
            ...
            <div className="flex flex-col lg:flex-row">
                <div className="p-6 sm:p-10 md:p-16 lg:p-20 w-full lg:w-1/2">
                    ...
                    <span className="block text-[#ac4e4e] text-lg md:text-xl lg:text-2xl mt-2">________</span>
                ...
                <div className="w-full lg:w-1/2 flex justify-center items-center p-4 sm:p-6 md:p-8 lg:p-10">
                    <img src="./images/tech.jpg" alt="Blood Center" className="w-full h-auto max-w-full" />
                </div>
            </div>
