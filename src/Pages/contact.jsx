...
function Contact() {
    ...
    return (
        ...
        <div className="min-h-[100vh] w-full">
            ...
            <div className="h-[300px] w-full bg-hero bg-cover bg-center flex justify-start items-center px-4 sm:px-6 md:px-10">
            ...
            <div className="flex flex-col lg:flex-row w-full">
                ...
                <div className="p-4 sm:p-6 md:p-8 lg:p-14 flex flex-col gap-6 lg:w-1/2">
                    ...
                    <div>
                        ...
                        <span className="text-gray-700 text-base md:text-lg">+90 (123) 456 78 99<br />+90 (123) 456 78 03</span>
                    </div>
                    <span className="text-red-500">______</span>
                    <div>

                        <h3 className="text-blue-600 text-lg md:text-xl">EMAIL:</h3>
                        <span className="text-gray-700 text-base md:text-lg">mail@demolink.com</span>
                    </div>
                    <span className="text-red-500">______</span>
                    <div>
                ...
                <div className="p-4 sm:p-6 md:p-8 lg:p-14 flex flex-col lg:w-1/2">
                    <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold">Write a Message</h1>
